...
module BancoBrasilPayments
  class InlineResponse200PaymentsList
    ...
    # The modality that represents the way the credit was given as follow:   1 - Credit in Current Account,  3 - Credit/Money Order or Wire Transfer (DOC/TED),  5 - Credit in Saving Account,  13 - Settlement of Bar-coded Slip,  21 - Settlement of Non Bar-coded Slip,  30 - Settlement of Bank Paper;  -  Modalidade que representa o modo como o crédito pago, sendo:  1 - Crédito em conta corrente,  3 - Crédito / Ordem de Pagamento ou Transferência Bancária (DOC / TED),  5 - Crédito em conta poupança  13 - Liquidação de Boleto com Código de Barras,  21 - Liquidação de Boleto sem Código de Barras,  30 - Liquidação de Boleto Bancário;
