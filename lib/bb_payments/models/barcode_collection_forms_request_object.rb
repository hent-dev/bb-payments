...
module BancoBrasilPayments
  # Objeto de Requiição para o recurso de pagamento em Batch Barcode Collection Forma
  class BarcodeCollectionFormsRequestObject
    ...
    # Lista de Guias de Pagamento detalhadas
    attr_accessor :collection_form_details_list
    ...
    def self.attribute_map
      {
        ...
        :'collection_form_details_list' => :'collectionFormDetailsList'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'collection_form_details_list' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BancoBrasilPayments::BarcodeCollectionFormsRequestObject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BancoBrasilPayments::BarcodeCollectionFormsRequestObject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'collection_form_details_list')
        if (value = attributes[:'collection_form_details_list']).is_a?(Array)
          self.collection_form_details_list = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @request_identification.nil?
        invalid_properties.push('invalid value for "request_identification", request_identification cannot be nil.')
      end

      if @collection_form_details_list.nil?
        invalid_properties.push('invalid value for "collection_form_details_list", collection_form_details_list cannot be nil.')
      end
    ...
    def valid?
      return false if @request_identification.nil?
      return false if @collection_form_details_list.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          collection_form_details_list == o.collection_form_details_list
    end
    ...
    def hash
      [request_identification, payment_contract, debit_branch_office, debit_current_account, check_digits_debit_current_account, collection_form_details_list].hash
    end
