...
module BancoBrasilPayments
  ...
  class InlineResponse2001
    ...
    # The modality that represents the way the credit was given as follow:   1 - Credit in Current Account,  3 - Credit/Money Order or Wire Transfer (DOC/TED),  5 - Credit in Saving Account,  71 – Deposit in Court;  -  Modalidade que representa o modo como o crédito pago, sendo:  1 - Crédito em conta corrente,  3 - Crédito / Ordem de Pagamento ou Transferência Bancária (DOC / TED),  5 - Crédito em conta poupança,  71 – Depósito Judicial no BB.
