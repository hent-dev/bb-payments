...
require 'bb_payments/models/barcode_collection_forms_id_response_object'
require 'bb_payments/models/barcode_collection_forms_id_response_object_lista_guia_codigo_barra'
require 'bb_payments/models/barcode_collection_forms_id_response_object_lista_ocorrencia'
require 'bb_payments/models/barcode_collection_forms_request_object'
require 'bb_payments/models/barcodecollectionforms_collection_form_details_list'
require 'bb_payments/models/batchtransfers_payments_list'
require 'bb_payments/models/batchtransferscancel_payment_ids'
...
# APIs
require 'bb_payments/api/base'
require 'bb_payments/api/pix_api'
require 'bb_payments/api/batch_payments'
require 'bb_payments/api/batch_payments_beta'
require 'bb_payments/api/bank_slips_api'
require 'bb_payments/api/cancel_api'
require 'bb_payments/api/collection_forms_api'
require 'bb_payments/api/returneds_api'
require 'bb_payments/api/transfers_api'
