...
# Unit tests for BancoBrasilPayments::TransfersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransfersApi' do
  before do
    # run before each test
    @instance = BancoBrasilPayments::TransfersApi.new
  end
  ...
  describe 'test an instance of TransfersApi' do
    it 'should create an instance of TransfersApi' do
      expect(@instance).to be_instance_of(BancoBrasilPayments::TransfersApi)
    end
  end
